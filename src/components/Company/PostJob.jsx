...
//   const handleWheel = (e) => {
//     e.stopPropagation(); // Prevent the scroll event from closing the drawer
//   };

//   const handleMouseDown = (e) => {
//     e.stopPropagation(); // Prevent the mouse down event from closing the drawer
//   };
...
//     <Drawer open={isOpen}  closeOnOverlayClick={false} trapFocus={false} className="p-10" draggable={false} >
//       <DrawerContent>
//         <DrawerHeader>
//           <DrawerTitle>Post a Job</DrawerTitle>
//         </DrawerHeader>
